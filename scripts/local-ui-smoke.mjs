...
async function testTerminal(page) {
  ...
  const code = codeText.replace(/\D/g, '').slice(-6);
  assert(code.length === 6, 'Demo SMS code was not shown');
  await fillBySelector(page, 'input[inputmode="numeric"][maxlength="6"]', code);
